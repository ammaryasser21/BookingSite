...
app.post('/api/login', async (req, res) => {
  try {
    ...
    console.log('Password matched, creating token for user:', email);
    ...
    jwt.sign(
      ...
      (err, token) => {
        ...
        // Set cookie with JWT token and respond with user data
        res
          .cookie('token', token, {
            httpOnly: true, // Ensures cookie is only accessible by the web server
            secure: process.env.NODE_ENV === 'production', // Sets Secure flag in production
